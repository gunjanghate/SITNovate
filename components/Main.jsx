  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-neutral-950">
      ...
      <div className="flex flex-col items-center justify-center gap-8 min-h-[50vh] w-full mx-auto text-black">
        <motion.h1
          className="text-center text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-blue-300 flex flex-col justify-center items-center" 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
        >
          Simplify Your Hiring & Preparations with  
        <span className="text-blue-500 font-extrabold text-5xl tracking-tighter " >SupaHire!</span>
        </motion.h1>
        <motion.div
          className="text-center text-lg text-gray-300 w-3/4 md:text-xl mt-4 font-medium flex flex-col justify-center items-center "
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5, duration: 1 }}
        >
          SupaHire streamlines recruitment with AI-powered tools, saving you
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:space-x-8 mt-10 lg:mt-16">
        {/* Card 1 */}
        <motion.div
          className="flex flex-col items-center justify-center w-[350px] h-[500px] md:w-[400px] md:h-[600px] lg:w-[450px] lg:h-[500px] bg-[#DEF9FF]/90 hover:bg-[#DEF9FF]  rounded-xl shadow-lg hover:shadow-2xl transform transition-transform duration-300 hover:scale-105"
        ...
        {/* Card 2 */}
        <motion.div
          className="flex flex-col items-center justify-center w-[350px] h-[500px] md:w-[400px] md:h-[600px] lg:w-[450px] lg:h-[500px] bg-[#DEF9FF]/90 hover:bg-[#DEF9FF]  rounded-xl shadow-lg hover:shadow-2xl transform transition-transform duration-300 hover:scale-105 md:mt-0 mt-5"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
